#!/bin/sh
echo "The following script will install puppet, git via yum, and clone l2tpvpn module from Github, and you have to enter an admin user's password to do this"
